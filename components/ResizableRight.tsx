...
export default function ResizableRight(
    props: React.HTMLProps<HTMLDivElement> & { draggedBorderHeight: string; width: number; setWidth: Dispatch<SetStateAction<number>> }
) {
    ...
    return (
        <div className="flex">
            {(width >= snapWidth || (!width && width !== 0)) && <div {...propsCopy}></div>}
